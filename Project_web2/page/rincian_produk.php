    ...
    <div class="row gx-5">
      <aside class="col-lg-6">
        <div class="border rounded-4 mb-3 d-flex justify-content-center">
          <a data-fslightbox="mygalley" class="rounded-4" target="_blank" data-type="image" href="..\assets\img\<?= $row['nama'] ?>.jpg">
      ...
      <main class="col-lg-6">
        <div class="ps-lg-3">
          ...
          <div class="row">
            ...
            <dd class="col-9">Adidas Samba</dd>

            <dt class="col-3">Color</dt>
            <dd class="col-9">Brown</dd>

            <dt class="col-3">Material</dt>
            <dd class="col-9">Suede</dd>

            <dt class="col-3">Merk</dt>
            <dd class="col-9">adidas</dd>
          </div>
          ...
          <div class="row mb-4">
            ...
            <a href="buat_pesanan.php" class="btn btn-warning shadow-0"> Buy now </a>
            ...
            <div class="tab-pane fade show active" id="ex1-pills-1" role="tabpanel" aria-labelledby="ex1-tab-1">
              ...
              <table class="table border mt-3 mb-2">
                <tr>
                  ...
                  <td class="py-2">Adidas</td>
                </tr>
                <tr>
                  <th class="py-2">Seri:</th>
                  <td class="py-2">Adidas Samba</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="py-2">Sneakers</td>
                </tr>
                <tr>
                  <th class="py-2">Material:</th>
                  <td class="py-2">Suede</td>
                </tr>
              </table>
            </div>
